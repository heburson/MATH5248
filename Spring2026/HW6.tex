...
\item (Peer review problem)  Prove that, if $a$ is a primitive root modulo $m$, then $a^{-1}$ (the multiplicative inverse of $a$ modulo $m$) is also a primitive root modulo $m$. \\
