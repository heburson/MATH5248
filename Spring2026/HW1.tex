...
\item Suppose you know that the plaintext ``snow" has been encoded to the ciphertext ``KEFN" using a shift cipher.  You intercept the ciphertext ``NZEKVI," which you know has been encoded with the same shift cipher.  Decrypt the second message ``NZEKVI." Make sure to show your work.   What type of attack did you perform?
