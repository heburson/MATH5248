...
$$\begin{cases} x\equiv 5\pmod{13}\\ x\equiv 2\pmod{7}\\ x\equiv 4 \pmod{11}\end{cases}$$
...
\begin{multicols}{2}
\begin{enumerate}
\item $\begin{cases} x\equiv 3\pmod{9}\\ x\equiv 2\pmod 6\\ x\equiv 1\pmod{5}\end{cases}$
\item $\begin{cases}x\equiv 5\pmod{9}\\ x\equiv 2\pmod 6\\ x\equiv 1\pmod{5}\end{cases}$
\end{enumerate}
\end{multicols}
